  ...
  if (navigationState) {
    return (
      <div className={[styles.BottomNavigation]}>
        <Link to="/home" style={{ textDecoration: "none", display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center' }}>
          <div className={styles.Icon}>
            <AiOutlineHome size={28} color={'#0E0E0F'} />
          </div>
          <BottomNavigationText className={styles.Text} text="Home" />
